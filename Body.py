...
class Body:
    ...
    def __init__(self, name, mass, bodyRadius):
        self.name = name
        self.mass = mass
    ...
    def setVelocity(self, velocity, scaled):
        if (scaled):
